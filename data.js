const database = {
    ...
    oneShotSubjects: {
        'phys1_oneshot': {
            name: "Physics 1st Paper One Shot", bn_name: "পদার্থবিজ্ঞান ১ম পত্র ওয়ান শট",
            chapters: [
        ...
        'phys2_oneshot': {
            name: "Physics 2nd Paper One Shot", bn_name: "পদার্থবিজ্ঞান ২য় পত্র ওয়ান শট",
            chapters: [
                { id: 'phys2_ch1_oneshot', name: "Chapter 01: Thermodynamics", bn_name: "তাপগতিবিদ্যা" }
            ]
        },
         'chem1_oneshot': {
            name: "Chemistry 1st Paper One Shot", bn_name: "রসায়ন ১ম পত্র ওয়ান শট",
            chapters: [
                { id: 'chem1_ch2_oneshot', name: "Chapter 02: Qualitative Chemistry", bn_name: "গুণগত রসায়ন" }
            ]
        },
        'math1_oneshot': {
            name: "Higher Math 1st Paper One Shot", bn_name: "উচ্চতর গণিত ১ম পত্র ওয়ান শট",
            chapters: [
                { id: 'math1_ch1_oneshot', name: "Chapter 01: Matrices and Determinants", bn_name: "ম্যাট্রিক্স ও নির্ণায়ক" }
            ]
        },
        'bio1_oneshot': {
            name: "Biology 1st Paper One Shot", bn_name: "জীববিজ্ঞান ১ম পত্র ওয়ান শট",
            chapters: [
